...
import { $styles, colors as defaultColor } from "../theme"
...
export interface TextFieldProps extends Omit<TextInputProps, "ref"> {
  /**
   * The name of text input, use case is for set data to store with dynamic key
   */
  name?: string
  /**
   * Return changed text with name
   */
    ...
    >
      {!!(label || labelTx) && (
        <Text
          ...
          color={defaultColor.palette.neutral480}
        />
      )}
      ...
      <View style={themed($inputWrapperStyles)}>
        ...
        <TextInput
          ...
          onChangeText={(value) => {
            TextInputProps.onChangeText?.(value?.toLowerCase())
            onTextChange?.(name ?? "", value?.toLowerCase())
          }}
        />
